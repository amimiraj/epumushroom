                        ...
                        <ul class="c_info_list">
                            <li class="m_bottom_10">
                                <div class="clearfix m_bottom_15">  
                                    ...
                                    <p class="contact_e">Head Office : Ward no:05, Bashurhat Pourosova,<br>  Companigonj, Noakhali, Chittagong Division,<br>  Bangladesh<br> </p>
                                </div>
                            </li>
                            <li class="m_bottom_10">
                            ...
                            <li class="m_bottom_10">
                                <div class="clearfix m_bottom_10">
                                    ...
                                    <a class="contact_e default_t_color" href="mailto:#">epumushroomhouse@gmail.com</a><br>
                                </div>
                            </li>
                        </ul>
                            ...
                            <ul>
                                <li class="clearfix m_bottom_15">
                                    <div class="f_left half_column">
                                        ...
                                        <input type="text" id="cf_name" name="contact_name" class="full_width r_corners">
                                    </div>
                                    <div class="f_left half_column">
                                        <label for="cf_email" class="required d_inline_b m_bottom_5">Email</label>
                                        <input type="email" id="cf_email" name="contact_email" class="full_width r_corners">
                                    </div>
                                </li>
                                <li class="m_bottom_15">
                                    <label for="cf_subject" class="d_inline_b m_bottom_5">Subject</label>
                                    <input type="text" id="cf_subject" name="contact_subject" class="full_width r_corners">
                                </li>
                                <li class="m_bottom_15">
                                    <label for="cf_message" class="d_inline_b m_bottom_5 required">Message</label>
                                    <textarea id="cf_message" name="contact_message" class="full_width r_corners"></textarea>
                                </li>
                                <li>
